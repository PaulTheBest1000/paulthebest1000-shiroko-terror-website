    ...
    function toggleMusic() {
        if (music.paused) {
            ...
            message.innerHTML = `Music is paused. Take a break! <br> 
                <a href="(https://youtu.be/I7A-xuDS-rA?si=TNjyc7MJvP8-gin7)" target="_blank" style="color: blue; text-decoration: underline;">
                    [Original Blue Archive OST 228 YouTube Video]
                </a>`;
        }
    }
...
function showMessage() {
    alert('WE LOVE SHIROKO TERROR!!!'); // Show alert with the message
